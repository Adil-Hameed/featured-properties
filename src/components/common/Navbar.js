      ...
      <div className='row w-90 mx-auto navbar'>
        <div className='col-12 d-flex align-items-end justify-content-between px-0 py-2 py-lg-4'>
          ...
          <div className='d-flex'>
            <p className='light-green mt-2 px-4 me-3 fw-normal py-2 mb-0 rounded roboto pointer'>
              Get Started
            </p>
            <p className='light-green mt-2 p-2 mb-0 fw-normal rounded roboto pointer'>
              Schedule Meeting
            </p>
          </div>
        </div>
